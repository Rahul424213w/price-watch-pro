...
const AlertsPage = () => {
  const { alerts, fetchAlerts, createAlert, getProductDetails, error } = useStore();
            ...
            <div key={alert.id} className="glass-card p-8 rounded-3xl flex items-center justify-between group hover:border-primary/40 transition-all duration-500 shadow-lg hover:shadow-2xl relative overflow-hidden">
              ...
              <div className="flex flex-col items-end gap-4 z-10">
                ...
                <div className="flex gap-2">
                   <button className="w-12 h-12 flex items-center justify-center bg-slate-50 text-slate-400 rounded-2xl hover:bg-slate-100 hover:text-primary transition-all border border-slate-100 shadow-sm"><Plus size={20} /></button>
                   <button className="w-12 h-12 flex items-center justify-center bg-slate-50 text-red-400 rounded-2xl hover:bg-red-50 hover:text-red-500 transition-all border border-slate-100 shadow-sm"><Trash2 size={20} /></button>
                </div>
              </div>
